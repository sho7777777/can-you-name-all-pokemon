...
import { OptionButtons } from '../../molecules/RegisterCompletedModal/OptionButtons';
import { TitleParts as TitlePartsRegiComp } from '../../molecules/RegisterCompletedModal/TitleParts';
import { TitleParts as TitlePartsRegiRank } from '../../molecules/RegisterRankingModal/TitleParts';
import { ButtonParts } from '../../molecules/RegisterRankingModal/ButtonParts';
import { InputParts } from '../../molecules/RegisterRankingModal/InputParts';
          ...
          <div className="relative w-full max-w-md h-full md:h-auto">
            ...
            <div className="relative bg-white rounded-lg">
              <div className="py-6 px-6 lg:px-8 rounded">
                <TitlePartsRegiRank />
                <InputParts {...InputPartsProps} />
                <ButtonParts registerRanking={registerRanking} isButtonDisabled={userNameValidation.isButtonDisabled}
        ...
        <div id="authentication-modal" className="overflow-y-auto overflow-x-hidden z-50 w-full md:inset-0 h-modal md:h-full justify-center items-center flex" aria-modal="true" role="dialog">
          <div className="relative p-4 w-full max-w-md h-full md:h-auto">
            <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
              <div className="py-6 px-6 lg:px-8 rounded">
                <TitlePartsRegiComp />
                <OptionButtons {...OptionButtonForRegiRankModalProps} />
              </div>
            </div>
          </div>
        </div>
