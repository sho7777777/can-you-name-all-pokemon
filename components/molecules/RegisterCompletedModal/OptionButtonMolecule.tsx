...
export const OptionButtonMolecule: FC<OptBtnForRegiRankModalProps> = (
  props
) => {
  const {
    shuffleFlg,
  ...
  return (
    <div className="flex flex-row justify-between w-full mx-auto ">
      <ButtonAtom style="btn-register" onClick={goToRankPage}>
        ランキングをみる
      </ButtonAtom>
      <ButtonAtom style="btn-basic" onClick={restart}>
        再チャレンジ！
      </ButtonAtom>
