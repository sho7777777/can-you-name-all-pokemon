  ...
  return (
    <div className="absolute bg-black inset-0 bg-opacity-60 flex justify-center z-10">
      <div className="relative bg-gray-200 rounded pt-2 w-96 h-1/2 mt-40">
        <TitleMolecule />
        <ImgMolecule correctAnswer={correctAnswer} currentPokeNo={currentPokeNo} pokeOrigin={pokeOrigin} />
        <YourScoreMolecule questionNo={questionNo} />
        <OptionButtonMolecule restart={restart} registerRanking={registerRanking} />
      </div>
    </div>
