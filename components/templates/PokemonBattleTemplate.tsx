...
export const PokemonBattleTemplate: FC<Props> = (props) => {
  ...
  return (
    <>
      {gameCompletedModalProps.isGameCompleted && (
        <GameCompModalOrganism {...gameCompletedModalProps} />
      )}
      {gameOverModalProps.isGameOver && (
        <GameOverModalOrganism {...gameOverModalProps} />
      )}
      {registerRankingModalProps.showRankingModal && (
        <RegiRankModalOrganism {...registerRankingModalProps} />
      )}
