...
export const RegiRankModalOrganism: FC<Props> = (props) => {
  ...
  const [userNameValidation, setUserNameValidation] =
    useState<userNameValidationProps>({
  ...
  const [isRegisterRankingCompleted, setIsRegisterRankingCompleted] =
  ...
  const OptBtnForRegiRankModalProps: OptBtnForRegiRankModalProps = {
    ...
    <div className="absolute bg-black inset-0 bg-opacity-60 flex justify-center items-center z-10">
      {!isRegisterRankingCompleted ? (
        <div
          ...
          className="overflow-y-auto overflow-x-hidden z-50 w-full md:inset-0 h-modal md:h-full justify-center items-center flex"
          aria-modal="true"
          role="dialog"
        >
          <div className="relative w-full max-w-md h-full md:h-auto">
            <div className="relative bg-white rounded-lg">
              <div className="py-6 px-6 lg:px-8 rounded">
                ...
                <ButtonMolecule
                  registerRanking={registerRanking}
                  isButtonDisabled={userNameValidation.isButtonDisabled}
          ...
          <div className="relative p-1 w-full max-w-md h-full md:h-auto">
            <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
              <div className="py-6 px-6 lg:px-8 rounded">
                ...
                <OptionButtonMolecule {...OptBtnForRegiRankModalProps} />
              </div>
            </div>
          </div>
        </div>
